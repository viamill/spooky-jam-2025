...
func _init() -> void:
	...
	match type:
		GameManager.GhostType.POLTERGEIST:
			possible_anomalies = [GameManager.AnomalyType.BROKEN, GameManager.AnomalyType.PLACED, GameManager.AnomalyType.ELECTRONIC, GameManager.AnomalyType.NONE, GameManager.AnomalyType.NONE]
		GameManager.GhostType.DEMON:
			possible_anomalies = [GameManager.AnomalyType.AUDIO, GameManager.AnomalyType.BROKEN, GameManager.AnomalyType.PLACED, GameManager.AnomalyType.NONE, GameManager.AnomalyType.NONE]
		GameManager.GhostType.WRAITH:
			possible_anomalies = [GameManager.AnomalyType.AUDIO, GameManager.AnomalyType.BROKEN, GameManager.AnomalyType.ELECTRONIC, GameManager.AnomalyType.NONE, GameManager.AnomalyType.NONE]
